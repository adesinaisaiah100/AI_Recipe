...
// // Use React environment variable convention
...
//   // Defensive: check if genAI/model is available
//   if (!genAI || !model) {
//     throw new Error("GoogleGenerativeAI or model not initialized.");
//   }
...
//   try {
//     const result = await chatSession.sendMessage("explain pythagoras theorem");
